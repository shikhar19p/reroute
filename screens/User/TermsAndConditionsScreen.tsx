    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Section
          ...
          body="All cancellation requests must be submitted to our support team at support@rerouteaventures.org or +91 82803 53535 / +91 76748 63535 with your Booking ID before the check-in time."
        />
        <Section
        ...
        <Section
          title="12. Contact"
          body="For questions about these terms, reach us at support@rerouteaventures.org or +91 82803 53535 / +91 76748 63535, or through the Contact Us section in the app."
        />
      </ScrollView>
    </SafeAreaView>
  );

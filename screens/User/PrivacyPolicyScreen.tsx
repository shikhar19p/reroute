  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top', 'left', 'right']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Section
          title="5. Your Rights"
          body="You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at support@rerouteaventures.org or +91 82803 53535 / +91 76748 63535. We will respond within 30 days."
        />
        <Section
        ...
        <Section
          title="7. Contact"
          body="For any privacy-related queries, reach us at support@rerouteaventures.org or +91 82803 53535 / +91 76748 63535, or through the Contact Us section in the app."
        />
      </ScrollView>
    </SafeAreaView>
  );
